...
https://ivlis.kr/lyrics-plus/ 링크를 통하여 접속하시면 임시로 최신버전 Spotify에서 확장 프로그램에 접근이 가능합니다.
설정 내보내기 후, 아래 과정을 따라 스포티파이를 구버전으로 설치하시길 권장합니다. (처음부터 다시 하기 귀찮잖아요..)
