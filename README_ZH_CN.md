...
- [ ] 修复当发音/翻译都禁用时，原歌词显示在发音字段的问题
- [ ] 与他人分享同步调整值以调整歌曲平均值的功能
- [ ] 防止服务器在歌词为纯音乐/少于2行时响应
- [ ] 在卡拉OK和同步歌词中启用滚动
- [ ] 修复在FullScreen中跳过没有歌词的歌曲时歌词无法正确重新加载的问题
- [ ] 修复同时启用翻译和发音时重新生成出现问题
- [ ] UI/UX英语和日语支持
- [ ] 紧急公告功能
- [ ] 根据翻译和发音语言设置生成相应语言
- [ ] 在右侧"正在播放"中添加歌词（可能实现也可能不行）
- [x] ~~特定语言原文字体功能~~ 2.1.3更新（改进为支持2种以上字体）
- [x] ~~歌词同步添加1000毫秒单位代替+-1~~ 2.1.2更新
- [x] ~~添加设置导出/导入功能~~ 2.0.8更新
- [x] ~~添加自定义歌词页面背景颜色选项~~ 2.0.6更新
- [x] ~~顶部栏模式锁定功能~~ 2.0.5更新
- [x] ~~修复Spotify重启后字体预览标签不显示设置字体的问题~~ 2.0.4更新
- [x] ~~修复GitHub按钮无法点击的问题~~ 2.0.4更新
- [x] ~~为每个歌词项目自定义字体~~ 2.0.3更新
- [x] ~~修复设置类别名称问题~~ 2.0.2更新
- [x] ~~检查更新版本和复制更新命令功能~~ 2.0.2更新
- [x] ~~修复启用假名显示时点击歌词按钮导致播放列表重置的问题~~ 2.0.1更新
---

**(此项目正在开发中。如遇到任何问题，请提供反馈)**
