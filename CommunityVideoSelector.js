    ...
    useEffect(() => {
        ...
        const syncToSpotify = () => {
            ...
            try {
                ...
                const lyricsStartTimeSec = (window.lyricsPlus_firstLyricTime || 0) / 1000; // ms -> 초
                ...
                if (Spicetify.Player.isPlaying()) {
                    if (playerState !== 1 && playerState !== 3) { // not playing and not buffering
...
const CommunityVideoSelector = ({ trackUri, currentVideoId, onVideoSelect, onClose }) => {
    ...
    return react.createElement("div", {
        ...
        react.createElement("div", {
            ...
            }, react.createElement("div", { className: "spinner" }), I18n.t("communityVideo.loading")) :
            ...
            react.createElement(react.Fragment, null,
                ...
                videos.length > 0 ? react.createElement("div", {
                    ...
                    videos.map((video, index) => react.createElement(react.Fragment, {
                        key: video.id
                    },
                        react.createElement("div", {
                            className: `community-video-item ${video.youtubeVideoId === currentVideoId ? 'active' : ''} ${index === 0 ? 'best' : ''}`
                        },
                            // Rank badge
                            react.createElement("div", {
                                className: `community-video-rank ${index === 0 ? 'gold' : index === 1 ? 'silver' : index === 2 ? 'bronze' : ''}`
                            }, index + 1),
                            ...
                            react.createElement("div", {
                                ...
                                // Preview button
                                react.createElement("button", {
                                    className: `action-btn preview ${previewVideoId === video.youtubeVideoId ? 'active' : ''}`,
                                ...
                                video.submitterId === currentUserHash && react.createElement("button", {
                        ...
                        previewVideoId === video.youtubeVideoId && react.createElement(SyncedVideoPreview, {
                ...
                }, showSubmitForm ? I18n.t("cancel") : I18n.t("communityVideo.addVideoNoEmoji")),
                
                // Submit Form
                showSubmitForm && react.createElement("div", {
                    className: "community-video-submit-form"
                },
                    react.createElement("div", {
                        className: "form-group"
                    },
                        react.createElement("label", null, I18n.t("communityVideo.youtubeUrl")),
                    ...
                    // 제목 표시
                    submitVideoTitle && react.createElement("div", {
                        className: "form-group video-title-preview"
                    },
                        react.createElement("label", null, I18n.t("communityVideo.videoTitle")),
                        react.createElement("div", {
                    ...
                    // 제목 로딩 중
                    isLoadingTitle && react.createElement("div", {
                        className: "form-group"
                    },
                        react.createElement("div", {
                    ...
                    react.createElement("div", {
                        ...
                        react.createElement("label", null, I18n.t("communityVideo.startTimeLabel")),
                        react.createElement("div", {
                            className: "form-hint"
                    ...
                    }, isSubmitting ? I18n.t("communityVideo.submitting") : I18n.t("communityVideo.submit"))
                )
            )
        ),
        ...
        react.createElement(ConfirmDialog, {
            ...
            title: I18n.t("communityVideo.delete"),
            message: I18n.t("communityVideo.deleteConfirm") + "\n\n" + deleteConfirmTitle,
